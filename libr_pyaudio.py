...
def compute_spectral_flux(spectrum, prev_spectrum):
...
def detect_tempo(signal):
    ...
    try:
        ...
        tempo = 0
        bt = 0
        print("Error in tempo detection")
...
try:
    while True:
        ...
        if audioQueue.empty() == False:
            ...
            tempo,bt = detect_tempo(audio_data)
            audio_data = tempo
            ...
            #compute the beat time and tempo
